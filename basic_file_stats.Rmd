...
- indexing
- rewrite the oldest file in group heuristic
- check that sourcerercc clone detection works, and change if not
- fix tokenizer & rerun if necessary
...
files$nonCloned = files$unique - sql.table.status("sourcerer_clone_info")$length

projects = list()
projects$total = sql.table.status("bookkeeping_proj")$length
...
println("Distinct file hashes:                   ", files$distinctFileHash, " ", files$distinctFileHash / files$total, "%")
println("Distinct token hashes:                  ", files$distinctTokenHash, " ", files$distinctTokenHash / files$total, "%")
println("Non-cloned files:                       ", files$nonCloned, " ", files$nonCloned / files$total, "%")
println("Projects with unique files:             ", projects$unique, " ", projects$unique / projects$total, "%")
println("Projects non-cloned files:              ", projects$nonCloned, " ", projects$nonCloned / projects$total, "%")
println("Projects with unique or original files: ", projects$uniqueAndOriginals, " ", projects$uniqueAndOriginals / projects$total, "%")
println("Projects non-cloned or original files:  ", projects$nonClonedAndOriginals, " ", projects$nonClonedAndOriginals / projects$total, "%")
```
